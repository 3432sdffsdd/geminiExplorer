...
export default function KumratTourPoster() {
  ...
  return (
    <>
      ...
      <div className="fixed left-4 bottom-4 z-[9998] flex flex-col items-center gap-1 md:left-6 md:bottom-6">
        <a
          href="https://wa.me/923003667466?text=I%20want%20to%20inquire%20about%20Kumrat%20package"
          target="_blank"
          rel="noopener noreferrer"
        ...
        <section className={styles.poster}>
          ...
          <section className={styles.hero}>
            <div className={styles.heroContent}>
              ...
              <div className={styles.locationLine}>
                ...
                <p>
                  Islamabad • Dir • Thal • Kumrat Valley • Kala Chashma •<br />
                  Kumrat Waterfall • Do Janga • Jahaz Banda • Islamabad
                </p>
              </div>
            </div>
          </section>
          ...
          <section className={styles.topInfo}>
            ...
            <div className={`${styles.infoBox} ${styles.imageBox}`}>
              <img
                ...
                src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=700&q=90"
                alt="Kumrat Valley landscape"
              />
            </div>
          </section>
          ...
          <section className={styles.itinerary}>
            <DayCard
              ...
              items={[
                ...
                "Visit Chakdara, Timergara and Dir City",
                "Enjoy Panjkora River views",
                "Continue journey towards Thal / Kumrat Valley",
                "Dinner & overnight stay in Thal / Kumrat",
              ]}
              styles={styles}
            />
            ...
            <DayCard
              ...
              items={[
                ...
                "Visit Kumrat Meadows",
                "Free time at riverside photography points",
                "Bonfire & BBQ optional",
                "Dinner & overnight stay in Kumrat Valley",
              ]}
              styles={styles}
            />
            ...
            <DayCard
              ...
              items={[
                ...
                "Visit Kala Chashma",
                "Visit Kumrat Waterfall",
                "Visit Do Janga",
                "Explore scenic river tracks",
                "Free time for photography and nature walks",
                "Dinner & overnight stay in Kumrat Valley",
              ]}
              styles={styles}
            />
            ...
            <DayCard
              ...
              items={[
                ...
                "Optional jeep ride towards Jahaz Banda",
                "Weather and road conditions permitting",
                "Optional camping experience",
                "Optional trout fish experience",
                "Riverside relaxation and free time",
                "Travel back towards Thal",
                "Dinner & overnight stay in Thal",
              ]}
              styles={styles}
            />
          ...
          <section className={styles.mainPanels}>
            <div className={styles.panel}>
              ...
              <ul>
                ...
                <li className={styles.check}>Hotel / camp accommodation as per policy</li>
          ...
          <section className={styles.bottomGrid}>
            <div className={styles.smallPanel}>
              ...
              <p>
                May to September is the best time to visit Kumrat Valley, when the
                weather is pleasant and most attractions are accessible.
              </p>
            </div>
